  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="bg-white dark:bg-gray-800 p-8 md:p-12 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700">
          <motion.div
          ...
          >
            {whyChooseUs.map((item, index) => (
              <motion.div
                key={index}
                className="bg-green-50 dark:bg-gray-700 rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300"
