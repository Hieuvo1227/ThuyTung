...
// allow password in the dialog data shape (avoid `any`)
                ...
                <ScrollArea className="h-[42vh] pr-4 mt-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-2 top-1/2 -translate-y-1/2 inline-flex items-center justify-center p-1 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"
                        >
                  ...
                  <div className="grid gap-2 mt-3">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        onChange("status" as keyof UserFormData, value as EUserStatus)
                      }
                    >
