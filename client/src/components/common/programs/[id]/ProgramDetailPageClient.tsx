...
export default function ProgramDetailPageClient({
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Set initial image source with fallback
      if (data?.imageUrl && data.imageUrl.trim() !== "") {
        setImageSrc(data.imageUrl);
      } else {
        setImageSrc("/images/placeholder-program.jpg");
      }
    };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <section className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 transition-colors">
        <div className="container mx-auto px-4 py-6">
                  <Button
                      onClick={() => router.back()}
                      className="mb-10 px-6 py-3 text-lg font-semibold bg-green-600 text-white hover:bg-green-700 transition-colors duration-200 flex items-center justify-center rounded-lg shadow-md"
                  >
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-primary">0908616014</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
